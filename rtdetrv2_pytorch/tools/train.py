...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--device', type=str, default='cuda', help='Dispositivo (GPU, CPU, etc.)')
    parser.add_argument('--seed', type=int, default=21, help='Semilla para reproducibilidad')
